...
function App() {
  ...
  return (
    <div className="mainPage">
      <NavBar addNewMovie={addNewMovie} setRateFilter={setRateFilter} setSearchFilter={setSearchFilter}/>
      <MovieList movies={movies} rateFilter={rateFilter} searchFilter={searchFilter}/>  
    </div>
  );
}
